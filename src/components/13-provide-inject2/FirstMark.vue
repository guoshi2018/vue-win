...
export default defineComponent({
  setup() {
    ...
    const userGeolocation = inject("geolocation") as Record<string, any>;
    const userUpdateLocation = inject("updateLocation") as (
      payload: MouseEvent
    ) => void;
    return {
      userLocation,
