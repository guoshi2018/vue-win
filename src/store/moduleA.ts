...
export default {
  ...
  } as GetterTree<Guoshi.Interfaces.VueState, Guoshi.Interfaces.Student>,
  ...
  mutations: {
    ...
    examMutaA: (...rest): void => {
      //			console.clear();
      print(debug, "examMutaA raised:", rest);
    },
    ...
    _getCount(state, obj: any) {
      ...
      obj.data = state.count; //反人类的操作,但是可以让消费端获取到值
    },
  } as MutationTree<Guoshi.Interfaces.VueState>,
  ...
  actions: {
    ...
    sameNameAct(context, payload: Guoshi.Types.Payload, ...rest) {
      print(debug, "sameNameAct of moduleA.ts called.");
    },
    anotherAct1(context, payload: Guoshi.Types.Payload, ...rest) {
      print(debug, "anotherAct of moduleA.ts called,call sameNameAct");
      context.dispatch("sameNameAct");
    },
    anotherAct2(context, payload: Guoshi.Types.ExamPayload, ...rest) {
      print(debug, "anotherAct2 of moduleA.ts called,call sameNameAct");
  ...
  } as ActionTree<Guoshi.Interfaces.VueState, Guoshi.Interfaces.Student>,
} as Module<Guoshi.Interfaces.VueState, Guoshi.Interfaces.Student>;
