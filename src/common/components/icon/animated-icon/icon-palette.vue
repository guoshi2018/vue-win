...
//import { TimelineMax, Sine, Back } from 'gsap-js';//ok,但是需要自己写type声明,否则因报错过多而无法使用lang="ts"
import { TweenMax, TimelineMax, Sine, gsap, Back } from "gsap";
...
export default defineComponent({
  methods: {
    movePalette() {
      ...
      //pick up here
      tl.add("start");
      this.mPalette(tl, this.$refs.light as Object, -5);
      this.mPalette(tl, this.$refs.med as Object, -15);
      this.mPalette(tl, this.$refs.dark as Object, -25);
      tl.to(
        this.$refs.pen as Object,
        0.6,
        {
          rotation: 20,
          x: 20,
      ...
      this.mPBack(tl, this.$refs.light as Object);
      this.mPBack(tl, this.$refs.med as Object);
      this.mPBack(tl, this.$refs.dark as Object);
      tl.to(
        this.$refs.pen as Object,
        0.4,
        {
    ...
    mPalette(tl: TimelineMax, el: gsap.TweenTarget, rot: gsap.TweenValue) {
      tl.to(
        el,
        0.6,
        {
    ...
    mPBack(tl: TimelineMax, el: gsap.TweenTarget) {
      tl.to(
        el,
        0.4,
        {
