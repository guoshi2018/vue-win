...
//import { TweenMax, Sine } from "gsap-js"; //ok,但是需要自己写type声明,否则因报错过多而无法使用lang="ts"
import { TweenMax, Sine, gsap } from "gsap";

export default defineComponent({
  methods: {
    startScissors() {
      this.scissorAnim(this.$refs.rightscissor as SVGGElement, 30);
      this.scissorAnim(this.$refs.leftscissor as SVGGElement, -30);
    },
    scissorAnim(el: gsap.TweenTarget, rot: gsap.TweenValue) {
      // TweenMax.to(el, 0.25, {  //old manual
      //   rotation: rot,
      //   repeat: 3,
      //   yoyo: true,
      //   svgOrigin: "50 45",
