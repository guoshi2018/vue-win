...
!(function (t, e) {
				...
				e
					? p(u)
						...
						: function (t) {
							...
							return (
								(s = !h || a <= h ? u[s] : t), l || s === t || q(t) ? s : s + Ra(t)
							);
						}
					: $a(u)
			)
		...
		return (
			ba(t, function (t) {
				for (var e in ((zt[t] = ot[t] = a), (zt[(n = t.toLowerCase())] = r), a))
					zt[n + ("easeIn" === e ? ".in" : "easeOut" === e ? ".out" : ".inOut")] = zt[
						t + "." + e
					] = a[e];
			}),
			a
		...
		Nt =
			(((It = Animation.prototype).delay = function delay(t) {
				...
				(It.endTime = function endTime(e) {
					return (
						this._start +
						(t(e) ? this.totalDuration() : this.duration()) / Math.abs(this._ts || 1)
					);
				}),
				...
				d =
					"get" !== r
						...
						: p(f)
							? h
								? t[
									e.indexOf("set") || !p(t["get" + e.substr(3)]) ? e : "get" + e.substr(3)
								](h)
								: t[e]()
							: f,
				_ = p(f) ? (h ? Zt : Wt) : Gt;
		...
		return (
			...
			(e.resetTo = function resetTo(t, e, r, i) {
				...
				return (
					...
					(function _updatePropTweens(t, e, r, i, n, a, s) {
						...
						: (Ba(this, 0),
							this.parent ||
							ra(this._dp, this, "_first", "_last", this._dp._sort ? "_start" : 0),
							this.render(0))
				);
			}),
			(e.kill = function kill(t, e) {
				...
				if (this.timeline) {
					...
					return (
						this.timeline.killTweensOf(t, e, Yt && !0 !== Yt.vars.overwrite)._first ||
						mb(this),
						this.parent &&
	...
	function Jd(t, e) {
		if (e.tween && e.tween._time === e.tween._dur) {
			...
			i &&
				(Bd(a, Ve),
					u && (u.svg && a.removeAttribute("transform"), He(a, 1), (u.uncache = 1)));
		}
	}
	function Nd(t) {
	...
	var le,
		...
		He = function _parseTransform(t, e) {
			...
			return (
				...
				r.svg &&
				((P =
					(!r.uncache || "0px 0px" === L) && !e && t.getAttribute("data-svg-origin")),
